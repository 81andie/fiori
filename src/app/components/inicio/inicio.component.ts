...
@Component({
  selector: 'app-inicio',
  imports: [RouterModule,  PoemasComponent, HeroComponent, HaikusComponent, HaikusMusicadosComponent, MorganComponent, TiamatComponent, SobreMiComponent, CabeceraComponent],
