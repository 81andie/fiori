...
import { CardReproductorReutilizableComponent } from "../card-reproductor-reutilizable/card-reproductor-reutilizable.component";
...
@Component({
  selector: 'app-reproductor-reutilizable',
  imports: [CardReproductorReutilizableComponent, CommonModule],
  templateUrl: './reproductor-reutilizable.component.html',
  styleUrl: './reproductor-reutilizable.component.css'
})
export class ReproductorReutilizableComponent  <T extends { audio: string }> implements OnInit, AfterViewInit, OnChanges{
